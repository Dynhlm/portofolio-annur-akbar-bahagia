...
//Style
const StyleSide = ["min-h-full bg-gray-400 w-72 lg:top-0 lg:left-0 top-14 lg:fixed left-[-300px] p-10 fixed duration-700","min-h-full bg-gray-400 w-72 lg:top-0 top-14 lg:fixed left-0 p-10 fixed duration-700"]
