...
//Style
const StyleSide = ["min-h-full bg-gray-400 w-72 lg:top-0 lg:left-0 top-14 lg:fixed left-[-300px] p-10 fixed duration-700","min-h-full bg-gray-400 w-72 lg:top-0 top-[54px] lg:fixed left-0 p-10 fixed duration-700"]
  ...
  return (
    <div className={side == "on" ? StyleSide[1]:StyleSide[0]}>
      <div className='flex justify-center align-middle mt-1'>
        <img src={fotoProfile} alt="" className='rounded-[50%] w-40 top-14'/>
      </div>
